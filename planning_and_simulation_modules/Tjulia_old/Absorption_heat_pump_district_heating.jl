module Absorption_heat_pump_district_heating
    ...
    function district_solver(input_folder, output_folder, tech_infos, network_id, print_function = print)
        ...
        writecsv(string(output_folder, "\\Result_CHP_ORC.csv",network_id ,".csv"), Result_CHP_ORC)
        ...
        writecsv(string(output_folder, "\\Result_HP_waste_heat_II_1.csv",network_id ,".csv"), Result_HP_waste_heat_II_1)
        writecsv(string(output_folder, "\\Result_HP_waste_heat_II_2.csv",network_id ,".csv"), Result_HP_waste_heat_II_2)
        writecsv(string(output_folder, "\\Result_HP_waste_heat_II_3.csv",network_id ,".csv"), Result_HP_waste_heat_II_3)

        writecsv(string(output_folder, "\\Result_HP_waste_heat_III_1.csv",network_id ,".csv"), Result_HP_waste_heat_III_1)
        writecsv(string(output_folder, "\\Result_HP_waste_heat_III_2.csv",network_id ,".csv"), Result_HP_waste_heat_III_2)
        writecsv(string(output_folder, "\\Result_HP_waste_heat_III_3.csv",network_id ,".csv"), Result_HP_waste_heat_III_3)
