...
class DistrictSimulator:
    ...
    cooling_heat_pump = ["Air source compression chillers", "Shallow geothermal compression chillers"] #[5]
    ...
    def __init__(self):
        ...
        self.technology_for_cooling = ['Air source compression chillers', #[0]
    ...
    def set_up_new_simulation(self):
        ...
        self.calc.baseline_tech_tab = self.baseline_tech_tab
        ...
        print('!!', self.calc.ef_sources_tab)
        print('!!', self.calc.pef_sources_tab)
    ...
    def single_building_simulation(self, dr, building_id):
        ...
        if self.baseline_scenario is None:
            print("DistrictSimulator, KPIs_baselineScenario: baseline_scenario is not defined")
            return
    ...
    def add_electrical_heater(self, tech_infos, val_list, input_folder=None):
        ...
        if val_list[self.name_to_index("tech_min")] > 0:
    ...
    def add_absorption_heat_pump(self, tech_infos, val_list, input_folder=None):
        ...
        return "absorption_HP"

    def add_cogeneration(self, tech_infos, val_list, input_folder=None):
        self.write_electricity_file(self, input_folder, val_list)
    ...
    def add_solar_thermal(self, tech_infos, val_list, input_folder=None):
        area = self.baseline_scenario.getFeature(val_list[0]).geometry().area()
    ...
    def add_cooling_heat_pump(self, tech_infos, val_list, input_folder=None):
        if tech_infos["P_max_HP_cool"] == 0:
            ...
            tech_infos["cost_var_HP_cool"] = [self.name_to_index("variable_cost")]
    ...
    def DCN_cogeneration(self, tech_infos, val_list, input_folder=None):
        self.write_electricity_file_district(self, input_folder, val_list)
    ...
    def create_file_for_julia_district(self, widget, network, input_folder, result_folder):
        ...
        files = self.waste_heat_file_list(result_folder)
        for i in range(widget.topLevelItemCount()):
            n = widget.topLevelItem(i)
            if n.data(0, Qt.UserRole) == network.get_ID():
                for j in range(n.childCount()):
                    ...
                    generate_fileEta_forJulia(COP_val_list, input_folder, input_folder)
    ...
    def gen_HEAT_Source_X_file(self, source, waste_heat_file_path):
        ...
        if source not in self.heat.keys():
            ...
            print("DistrictSimulator.py, gen_T_Source_X_file(): writing:", waste_heat_file_path)
