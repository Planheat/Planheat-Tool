...
class KPIsCalculator:
    ...
    baseline_tech_tab = None  # only used in future
    baseline_network_tech_tab = None  # only used in future
    future_tech_tab = None  # only used in future
    future_network_tech_tab = None  # only used in future
    ...
    def initialize(self):
        ...
        self.eco_param["demo_factor"] = 1
        self.eco_param["eta_d"] = 1
    ...
    def district_KPIs_update(self):
        ...
        self.fec_s0 = self.fec + tmp[0]
        self.fec_s1 = self.fec + tmp[1]
        self.fec_s2 = self.fec + tmp[2]
        self.fec_s3 = self.fec + tmp[3]
        self.fec_s4 = self.fec + tmp[4]
        self.fec_s5 = self.fec + tmp[5]
        self.fec_s6 = self.fec + tmp[6]
        self.fec_s7 = self.fec + tmp[7]
        self.fec_s8 = self.fec + tmp[8]
        self.fec_s9 = self.fec + tmp[9]
        self.fec_s10 = self.fec + tmp[10]
        self.fec_s11 = self.fec + tmp[11]
        self.fec_s12 = self.fec + tmp[12]
        self.fec_s13 = self.fec + tmp[13]
        self.fec_s14 = self.fec + tmp[14]
        self.fec_s15 = self.fec + tmp[15]
        self.fec_s16 = self.fec + tmp[16]
        self.fec_s17 = self.fec + tmp[17]
        self.fec_s18 = self.fec + tmp[18]
        self.fec_s19 = self.fec + tmp[19]
        self.fec_s20 = self.fec + tmp[20]
        self.fec_s21 = self.fec + tmp[21]
        self.fec_s22 = self.fec + tmp[22]

        self.fecDistrict = self.fecDistrict + np.sum(tmp)

        #self.fecR = self.fecR + tmp * residential_factor
        self.fecR_s0 = self.fecR + tmp[0] * residential_factor
        self.fecR_s1 = self.fecR + tmp[1] * residential_factor
        self.fecR_s2 = self.fecR + tmp[2] * residential_factor
        self.fecR_s3 = self.fecR + tmp[3] * residential_factor
        self.fecR_s4 = self.fecR + tmp[4] * residential_factor
        self.fecR_s5 = self.fecR + tmp[5] * residential_factor
        self.fecR_s6 = self.fecR + tmp[6] * residential_factor
        self.fecR_s7 = self.fecR + tmp[7] * residential_factor
        self.fecR_s8 = self.fecR + tmp[9] * residential_factor
        self.fecR_s10 = self.fecR + tmp[10] * residential_factor
        self.fecR_s11 = self.fecR + tmp[11] * residential_factor
        self.fecR_s12 = self.fecR + tmp[12] * residential_factor
        self.fecR_s13 = self.fecR + tmp[13] * residential_factor
        self.fecR_s14 = self.fecR + tmp[14] * residential_factor
        self.fecR_s15 = self.fecR + tmp[15] * residential_factor
        self.fecR_s16 = self.fecR + tmp[16] * residential_factor
        self.fecR_s17 = self.fecR + tmp[17] * residential_factor
        self.fecR_s18 = self.fecR + tmp[18] * residential_factor
        self.fecR_s19 = self.fecR + tmp[19] * residential_factor
        self.fecR_s20 = self.fecR + tmp[20] * residential_factor
        self.fecR_s21 = self.fecR + tmp[21] * residential_factor
        self.fecR_s22 = self.fecR + tmp[22] * residential_factor

        self.fecT_s0 = self.fecT + tmp[0] * (1 - residential_factor)
        self.fecT_s1 = self.fecT + tmp[1] * (1 - residential_factor)
        self.fecT_s2 = self.fecT + tmp[2] * (1 - residential_factor)
        self.fecT_s3 = self.fecT + tmp[3] * (1 - residential_factor)
        self.fecT_s4 = self.fecT + tmp[4] * (1 - residential_factor)
        self.fecT_s5 = self.fecT + tmp[5] * (1 - residential_factor)
        self.fecT_s6 = self.fecT + tmp[6] * (1 - residential_factor)
        self.fecT_s7 = self.fecT + tmp[7] * (1 - residential_factor)
        self.fecT_s8 = self.fecT + tmp[9] * (1 - residential_factor)
        self.fecT_s10 = self.fecT + tmp[10] * (1 - residential_factor)
        self.fecT_s11 = self.fecT + tmp[11] * (1 - residential_factor)
        self.fecT_s12 = self.fecT + tmp[12] * (1 - residential_factor)
        self.fecT_s13 = self.fecT + tmp[13] * (1 - residential_factor)
        self.fecT_s14 = self.fecT + tmp[14] * (1 - residential_factor)
        self.fecT_s15 = self.fecT + tmp[15] * (1 - residential_factor)
        self.fecT_s16 = self.fecT + tmp[16] * (1 - residential_factor)
        self.fecT_s17 = self.fecT + tmp[17] * (1 - residential_factor)
        self.fecT_s18 = self.fecT + tmp[18] * (1 - residential_factor)
        self.fecT_s19 = self.fecT + tmp[19] * (1 - residential_factor)
        self.fecT_s20 = self.fecT + tmp[20] * (1 - residential_factor)
        self.fecT_s21 = self.fecT + tmp[21] * (1 - residential_factor)
        self.fecT_s22 = self.fecT + tmp[22] * (1 - residential_factor)
        ...
        if self.future_scenario is not None:
            self.opex = self.opex + self.district_FECfut_tech_per_energy_tariff() + self.districtOeM_cost()
            ...
            self.fuel_cost_savingR = self.fuel_cost_savingT + self.district_FECfut_tech_per_energy_tariff(use="T") * (1 + self.eco_param["demo_factor"])
        if self.future_scenario is not None:
        ...
        self.el_sale += self.get_el_sale_increment_district()
    ...
    def individual_KPIs_update(self):
        ...
        if self.building_tag == "Residential":
            self.fecR_s0 = self.fecR + tmp[0]
            self.fecR_s1 = self.fecR + tmp[1]
            self.fecR_s2 = self.fecR + tmp[2]
            self.fecR_s3 = self.fecR + tmp[3]
            self.fecR_s4 = self.fecR + tmp[4]
            self.fecR_s5 = self.fecR + tmp[5]
            self.fecR_s6 = self.fecR + tmp[6]
            self.fecR_s7 = self.fecR + tmp[7]
            self.fecR_s8 = self.fecR + tmp[9]
            self.fecR_s10 = self.fecR + tmp[10]
            self.fecR_s11 = self.fecR + tmp[11]
            self.fecR_s12 = self.fecR + tmp[12]
            self.fecR_s13 = self.fecR + tmp[13]
            self.fecR_s14 = self.fecR + tmp[14]
            self.fecR_s15 = self.fecR + tmp[15]
            self.fecR_s16 = self.fecR + tmp[16]
            self.fecR_s17 = self.fecR + tmp[17]
            self.fecR_s18 = self.fecR + tmp[18]
            self.fecR_s19 = self.fecR + tmp[19]
            self.fecR_s20 = self.fecR + tmp[20]
            self.fecR_s21 = self.fecR + tmp[21]
            self.fecR_s22 = self.fecR + tmp[22]
        else:
            self.fecT_s0 = self.fecT + tmp[0]
            self.fecT_s1 = self.fecT + tmp[1]
            self.fecT_s2 = self.fecT + tmp[2]
            self.fecT_s3 = self.fecT + tmp[3]
            self.fecT_s4 = self.fecT + tmp[4]
            self.fecT_s5 = self.fecT + tmp[5]
            self.fecT_s6 = self.fecT + tmp[6]
            self.fecT_s7 = self.fecT + tmp[7]
            self.fecT_s8 = self.fecT + tmp[9]
            self.fecT_s10 = self.fecT + tmp[10]
            self.fecT_s11 = self.fecT + tmp[11]
            self.fecT_s12 = self.fecT + tmp[12]
            self.fecT_s13 = self.fecT + tmp[13]
            self.fecT_s14 = self.fecT + tmp[14]
            self.fecT_s15 = self.fecT + tmp[15]
            self.fecT_s16 = self.fecT + tmp[16]
            self.fecT_s17 = self.fecT + tmp[17]
            self.fecT_s18 = self.fecT + tmp[18]
            self.fecT_s19 = self.fecT + tmp[19]
            self.fecT_s20 = self.fecT + tmp[20]
            self.fecT_s21 = self.fecT + tmp[21]
            self.fecT_s22 = self.fecT + tmp[22]
        ...
        self.el_sale += self.get_el_sale_increment_building()
    ...
    def close_calculation(self, KPIs_baseline=None):
        ...
        if KPIs_baseline is not None:
            ...
            self.PEC_RESWH = self.PEC_base[-2] + self.PEC_base[3] + self.PEC_base[4] + self.PEC_base[5] + self.PEC_base[
                6] + self.PEC_base[7] + self.PEC_base[8] + self.PEC_base[9] + self.PEC_base[10] + self.PEC_base[11] + \
                             ...
                             self.PEC_base[20]
            self.PEC_RESWHR = self.PEC_baseR[-2] + self.PECR_base[3] + self.PECR_base[4] + self.PECR_base[5] + \
                              self.PECR_base[6] + self.PEC_baseR[7] + self.PEC_baseR[8] + self.PEC_baseR[9] + \
            ...
            self.PEC_RESWHT = self.PEC_baseT[-2] + self.PECT_base[3] + self.PECT_base[4] + self.PECT_base[5] + \
                              self.PECT_base[6] + self.PEC_baseT[7] + self.PEC_baseT[8] + self.PEC_baseT[9] + \
            ...
            KPIs["EN_2.3R_s12"] = self.fecR_s13
            ...
            KPIs["EN_2.3T_s11"] = self.fecT_s12
            ...
            KPIs["EN_4.3R"] = self.PEC_baseR[-2] + self.PECR_base[3] + self.PECR_base[4] + self.PECR_base[5] + self.PECR_base[6]
            KPIs["EN_4.3T"] = self.PEC_baseT[-2] + self.PECT_base[3] + self.PECT_base[4] + self.PECT_base[5] + self.PECT_base[6]
            ...
            try:
                ...
                KPIs["EN_6.5T"] = "Nan"
            KPIs["EN_7.3"] = self.PEC_base[0] + self.PEC_base[1] + self.PEC_base[2]
            KPIs["EN_7.3R"] = self.PEC_base[0] + self.PEC_base[1] + self.PEC_base[2]
            KPIs["EN_7.3T"] = self.PEC_base[0] + self.PEC_base[1] + self.PEC_base[2]
            try:
            ...
            try:
                ...
                KPIs["EN_9.2T"] = "Nan"
            try:
                KPIs["EN_11.1"] = round((self.PEC_base[6] / KPIs["EN_1.3"]) * 100, 2)
            except (ZeroDivisionError, TypeError, KeyError) as e:
                KPIs["EN_11.1"] = "Nan"
            KPIs["EN_11.1R"] = round((self.PEC_baseR[6] / KPIs["EN_1.3R"]) * 100, 2)
            KPIs["EN_11.1T"] = round((self.PEC_baseT[6] / KPIs["EN_1.3T"]) * 100, 2)

            KPIs["EN_11.3"] = self.fec_s6
            KPIs["EN_11.3R"] = self.fecR_s6
            KPIs["EN_11.3R"] = self.fecT_s6

            KPIs["EN_12.2"] = self.PEC_RESWH / KPIs["EN_1.3"]
            KPIs["EN_12.2R"] = self.PEC_RESWHR / KPIs["EN_1.3R"]
            KPIs["EN_12.2T"] = self.PEC_RESWHT / KPIs["EN_1.3T"]
            try:
                KPIs["EN_12.3"] = (KPIs["EN_12.2"] / self.RESWHadjBase - 1) * 100
            except (ZeroDivisionError, TypeError) as e:
                KPIs["EN_12.3"] = "Nan"
            try:
                KPIs["EN_12.3R"] = (KPIs["EN_12.2R"] / self.RESWHadjBaseR - 1) * 100
            except (ZeroDivisionError, TypeError) as e:
                KPIs["EN_12.3R"] = "Nan"
            try:
                KPIs["EN_12.3T"] = (KPIs["EN_12.2T"] / self.RESWHadjBaseT - 1) * 100
            except (ZeroDivisionError, TypeError) as e:
                KPIs["EN_12.3T"] = "Nan"

                KPIs["EN_13.2"] = KPIs["EN_3.3"] * (1 / self.eco_param["eta_d"])
                KPIs["EN_13.2R"] = KPIs["EN_3.3R"] * (1 / self.eco_param["eta_d"])
                KPIs["EN_13.2T"] = KPIs["EN_3.3T"] * (1 / self.eco_param["eta_d"])
            ...
            # KPIs["EN_13.3bT"] = "Nan"
            try:
                KPIs["EN_14.2"] = self.fecDistrict / self.h_length
            except(ZeroDivisionError, TypeError) as e:
                KPIs["EN_14.2"] = "Nan"
            try:
                KPIs["EN_14.3"] = (KPIs["EN_14.2"] / KPIs["EN_14.1"] - 1) * 100
            except (ZeroDivisionError, TypeError) as e:
                KPIs["EN_14.3a"] = "Nan"
            try:
            ...
            fecR = [KPIs["EN_2.1R_s" + str(i)] for i in range(len(self.sourceName))]
            fecT = [KPIs["EN_2.1T_s" + str(i)] for i in range(len(self.sourceName))]
            KPIs["ENV_2.3"] = self.get_t_pollutant_future(fec, self.pollutant_colum_index["NO2"])
            KPIs["ENV_2.3R"] = self.get_t_pollutant_future(fecR, self.pollutant_colum_index["NO2"])
            KPIs["ENV_2.3T"] = self.get_t_pollutant_future(fecT, self.pollutant_colum_index["NO2"])
            try:
            ...
            self.PEC_baseRes = [self.PEC_base[-2], self.PEC_base[3], self.PEC_base[4], self.PEC_base[5], self.PEC_base[6]]
            self.PEC_baseResR = [self.PEC_baseR[-2], self.PEC_baseR[3], self.PEC_baseR[4], self.PEC_baseR[5], self.PEC_baseR[6]]
            self.PEC_baseResT = [self.PEC_baseT[-2], self.PEC_baseT[3], self.PEC_baseT[4], self.PEC_baseT[5], self.PEC_baseT[6]]
            ...
            self.PEC_baseRESWH_sum = sum(self.PEC_baseWH) + np.sum(self.PEC_baseRes)
            self.PEC_baseRESWHR_sum = sum(self.PEC_baseWHR) + np.sum(self.PEC_baseResR)
            self.PEC_baseRESWHT_sum = sum(self.PEC_baseWHT) + np.sum(self.PEC_baseResT)
            ...
            KPIs["EN_2.1_s3"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s4"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s5"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s6"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s7"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s8"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s9"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s10"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s11"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s12"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s13"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s14"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s15"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s16"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s17"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s18"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s19"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s20"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s21"] = round(self.fec_s2, 2)
            KPIs["EN_2.1_s22"] = round(self.fec_s2, 2)

            self.fec_s0_base = round(self.fec_s0, 2)
            self.fec_s1_base = round(self.fec_s1, 2)
            self.fec_s2_base = round(self.fec_s2, 2)
            self.fec_s3_base = round(self.fec_s3, 2)
            self.fec_s4_base = round(self.fec_s4, 2)
            self.fec_s5_base = round(self.fec_s5, 2)
            self.fec_s6_base = round(self.fec_s6, 2)
            self.fec_s7_base = round(self.fec_s7, 2)
            self.fec_s8_base = round(self.fec_s8, 2)
            self.fec_s9_base = round(self.fec_s9, 2)
            self.fec_s10_base = round(self.fec_s10, 2)
            self.fec_s11_base = round(self.fec_s11, 2)
            self.fec_s12_base = round(self.fec_s12, 2)
            self.fec_s13_base = round(self.fec_s13, 2)
            self.fec_s14_base = round(self.fec_s14, 2)
            self.fec_s15_base = round(self.fec_s15, 2)
            self.fec_s16_base = round(self.fec_s16, 2)
            self.fec_s17_base = round(self.fec_s17, 2)
            self.fec_s18_base = round(self.fec_s18, 2)
            self.fec_s19_base = round(self.fec_s19, 2)
            self.fec_s20_base = round(self.fec_s20, 2)
            self.fec_s21_base = round(self.fec_s21, 2)
            self.fec_s22_base = round(self.fec_s22, 2)
            ...
            self.fecR_s0_base = round(self.fecR_s0, 2)
            self.fecR_s1_base = round(self.fecR_s1, 2)
            self.fecR_s2_base = round(self.fecR_s2, 2)
            self.fecR_s3_base = round(self.fecR_s3, 2)
            self.fecR_s4_base = round(self.fecR_s4, 2)
            self.fecR_s5_base = round(self.fecR_s5, 2)
            self.fecR_s6_base = round(self.fecR_s6, 2)
            self.fecR_s7_base = round(self.fecR_s7, 2)
            self.fecR_s8_base = round(self.fecR_s8, 2)
            self.fecR_s9_base = round(self.fecR_s9, 2)
            self.fecR_s10_base = round(self.fecR_s10, 2)
            self.fecR_s11_base = round(self.fecR_s11, 2)
            self.fecR_s12_base = round(self.fecR_s12, 2)
            self.fecR_s13_base = round(self.fecR_s13, 2)
            self.fecR_s14_base = round(self.fecR_s14, 2)
            self.fecR_s15_base = round(self.fecR_s15, 2)
            self.fecR_s16_base = round(self.fecR_s16, 2)
            self.fecR_s17_base = round(self.fecR_s17, 2)
            self.fecR_s18_base = round(self.fecR_s18, 2)
            self.fecR_s19_base = round(self.fecR_s19, 2)
            self.fecR_s20_base = round(self.fecR_s20, 2)
            self.fecR_s21_base = round(self.fecR_s21, 2)
            self.fecR_s22_base = round(self.fecR_s22, 2)
            # ..............
            ...
            self.fecT_s0_base = round(self.fecT_s0, 2)
            self.fecT_s1_base = round(self.fecT_s1, 2)
            self.fecT_s2_base = round(self.fecT_s2, 2)
            self.fecT_s3_base = round(self.fecT_s3, 2)
            self.fecT_s4_base = round(self.fecT_s4, 2)
            self.fecT_s5_base = round(self.fecT_s5, 2)
            self.fecT_s6_base = round(self.fecT_s6, 2)
            self.fecT_s7_base = round(self.fecT_s7, 2)
            self.fecT_s8_base = round(self.fecT_s8, 2)
            self.fecT_s9_base = round(self.fecT_s9, 2)
            self.fecT_s10_base = round(self.fecT_s10, 2)
            self.fecT_s11_base = round(self.fecT_s11, 2)
            self.fecT_s12_base = round(self.fecT_s12, 2)
            self.fecT_s13_base = round(self.fecT_s13, 2)
            self.fecT_s14_base = round(self.fecT_s14, 2)
            self.fecT_s15_base = round(self.fecT_s15, 2)
            self.fecT_s16_base = round(self.fecT_s16, 2)
            self.fecT_s17_base = round(self.fecT_s17, 2)
            self.fecT_s18_base = round(self.fecT_s18, 2)
            self.fecT_s19_base = round(self.fecT_s19, 2)
            self.fecT_s20_base = round(self.fecT_s20, 2)
            self.fecT_s21_base = round(self.fecT_s21, 2)
            self.fecT_s22_base = round(self.fecT_s22, 2)
            ...
            try:
                ...
                KPIs["EN_2.2"] = "Nan"
            try:
                KPIs["EN_2.2R_s0"] = round(self.fecR_s0 / self.area, 2)
                KPIs["EN_2.2R_s1"] = round(self.fecR_s1 / self.area, 2)
                KPIs["EN_2.2R_s2"] = round(self.fecR_s2 / self.area, 2)
                KPIs["EN_2.2R_s3"] = round(self.fecR_s3 / self.area, 2)
                KPIs["EN_2.2R_s4"] = round(self.fecR_s4 / self.area, 2)
                KPIs["EN_2.2R_s5"] = round(self.fecR_s5 / self.area, 2)
                KPIs["EN_2.2R_s6"] = round(self.fecR_s6 / self.area, 2)
                KPIs["EN_2.2R_s7"] = round(self.fecR_s7 / self.area, 2)
                KPIs["EN_2.2R_s8"] = round(self.fecR_s8 / self.area, 2)
                KPIs["EN_2.2R_s9"] = round(self.fecR_s9 / self.area, 2)
                KPIs["EN_2.2R_s11"] = round(self.fecR_s10 / self.area, 2)
                KPIs["EN_2.2R_s12"] = round(self.fecR_s12 / self.area, 2)
                KPIs["EN_2.2R_s13"] = round(self.fecR_s13 / self.area, 2)
                KPIs["EN_2.2R_s14"] = round(self.fecR_s14 / self.area, 2)
                KPIs["EN_2.2R_s15"] = round(self.fecR_s15 / self.area, 2)
                KPIs["EN_2.2R_s16"] = round(self.fecR_s16 / self.area, 2)
                KPIs["EN_2.2R_s18"] = round(self.fecR_s18 / self.area, 2)
                KPIs["EN_2.2R_s19"] = round(self.fecR_s19 / self.area, 2)
                KPIs["EN_2.2R_s20"] = round(self.fecR_s20 / self.area, 2)
                KPIs["EN_2.2R_s21"] = round(self.fecR_s21 / self.area, 2)
                KPIs["EN_2.2R_s22"] = round(self.fecR_s22 / self.area, 2)
            except(ZeroDivisionError, TypeError) as e:
                KPIs["EN_2.2R"] = "Nan"
            try:
                KPIs["EN_2.2T_s0"] = round(self.fecT_s0 / self.area, 2)
                KPIs["EN_2.2T_s1"] = round(self.fecT_s1 / self.area, 2)
                KPIs["EN_2.2T_s2"] = round(self.fecT_s2 / self.area, 2)
                KPIs["EN_2.2T_s3"] = round(self.fecT_s3 / self.area, 2)
                KPIs["EN_2.2T_s4"] = round(self.fecT_s4 / self.area, 2)
                KPIs["EN_2.2T_s5"] = round(self.fecT_s5 / self.area, 2)
                KPIs["EN_2.2T_s6"] = round(self.fecT_s6 / self.area, 2)
                KPIs["EN_2.2T_s7"] = round(self.fecT_s7 / self.area, 2)
                KPIs["EN_2.2T_s8"] = round(self.fecT_s8 / self.area, 2)
                KPIs["EN_2.2T_s9"] = round(self.fecT_s9 / self.area, 2)
                KPIs["EN_2.2T_s10"] = round(self.fecT_s10 / self.area, 2)
                KPIs["EN_2.2T_s11"] = round(self.fecT_s11 / self.area, 2)
                KPIs["EN_2.2T_s12"] = round(self.fecT_s12 / self.area, 2)
                KPIs["EN_2.2T_s13"] = round(self.fecT_s13 / self.area, 2)
                KPIs["EN_2.2T_s14"] = round(self.fecT_s14 / self.area, 2)
                KPIs["EN_2.2T_s15"] = round(self.fecT_s15 / self.area, 2)
                KPIs["EN_2.2T_s16"] = round(self.fecT_s16 / self.area, 2)
                KPIs["EN_2.2T_s17"] = round(self.fecT_s17 / self.area, 2)
                KPIs["EN_2.2T_s18"] = round(self.fecT_s18 / self.area, 2)
                KPIs["EN_2.2T_s19"] = round(self.fecT_s19 / self.area, 2)
                KPIs["EN_2.2T_s20"] = round(self.fecT_s20 / self.area, 2)
                KPIs["EN_2.2T_s21"] = round(self.fecT_s21 / self.area, 2)
                KPIs["EN_2.2T_s22"] = round(self.fecT_s22 / self.area, 2)
            except(ZeroDivisionError, TypeError) as e:
                KPIs["EN_2.2T"] = "Nan"
            ...
            try:
                ...
                KPIs["EN_9.1T"] = "Nan"
            KPIs["EN_11.3"] = round(100 * self.PEC_base[6] / self.PEC_base_SUM, 2)
            KPIs["EN_11.3R"] = round(100 * self.PEC_baseR[6] / self.PEC_baseR_SUM, 2)
            KPIs["EN_11.3T"] = round(100 * self.PEC_baseT[6] / self.PEC_baseT_SUM, 2)

            KPIs["EN_12.1"] = self.PEC_baseRESWH_sum / KPIs["EN_1.1"] * 100
            KPIs["EN_12.1R"] = self.PEC_baseRESWHR_sum / KPIs["EN_1.1R"] * 100
            KPIs["EN_12.1T"] = self.PEC_baseRESWHR_sum / KPIs["EN_1.1T"] * 100
            KPIs["EN_13.1"] = KPIs["EN_3.1"] * (1 / self.eco_param["eta_d"])
            KPIs["EN_13.1R"] = KPIs["EN_3.1R"] * (1 / self.eco_param["eta_d"])
            KPIs["EN_13.1T"] = KPIs["EN_3.1T"] * (1 / self.eco_param["eta_d"])
            ...
            try:
                KPIs["EN_14.1"] = self.fecDistrict / self.h_length
            except(ZeroDivisionError, TypeError) as e:
                KPIs["EN_14.1"] = "Nan"
            try:
            ...
            fecR = [KPIs["EN_2.1R_s" + str(i)] for i in range(len(self.sourceName))]
            fecT = [KPIs["EN_2.1T_s" + str(i)] for i in range(len(self.sourceName))]
            KPIs["ENV_2.1"] = self.get_t_pollutant_baseline(fec, self.pollutant_colum_index["NO2"])
            KPIs["ENV_2.1R"] = self.get_t_pollutant_baseline(fecR, self.pollutant_colum_index["NO2"])
            KPIs["ENV_2.1T"] = self.get_t_pollutant_baseline(fecT, self.pollutant_colum_index["NO2"])
            try:
    ...
    def getPEF_source(self):
        PEF = [0.0 for i in range(len(self.sourceName))]
    ...
    def locsourbase_KPi(self, pec):
        ...
        for i in range(self.step0_district_sources_tab.rowCount()):
            try:
                ...
                print(
                    "KPIsCalculator, locsourbase_KPi. float(self.step0_district_sources_tab.item(i, column-1) rises some error")
                return 0
        try:
            v = sour / pec
        except(ZeroDivisionError, TypeError) as e:
    ...
    def building_FEC_calculation(self, dr, item, building_id):
        ...
        # double_tech_elect = ["Waste heat - heat pump – temperature group 3","Air source compression heat pump","Waste heat compression heat pump medium T",
        # "Seasonal waste heat heat pumps","Waste heat - heat pump – temperature group 2","Waste heat compression heat pump low T",
        # "Waste heat - heat pump – temperature group 1 "]

        # double_tech = ["Shallow geothermal compression heat pump", "Air source gas absorption heat pump", "Shallow geothermal gas absorption heat pump",
        # "Waste heat absorption heat pump",]

        const_eff = ["Gas Boiler", "Biomass Boiler", "Oil Boiler", "Electrical heater", "gas CHP", "Oil CHP", "Biomass CHP",
                     "Industrial waste heat ORC", "Deep geothermal ORC", "Gas ORC", "Biomass ORC", "Deep geothermal HEX",
                     "Industrial waste heat HEX",
                     "Evacuated tube solar collectors", "Flat plate solar collectors",
                     "Air source gas absorption heat pump", "Shallow geothermal gas absorption heat pump", ]
        ...
        for i in range(item.childCount()):  # cooling heating DHW #technology
            ...
            for j in range(scope_item.childCount()):  # technology
                ...
                for jj in range(len(const_eff)):
                    if technology == const_eff[jj] and const_eff[jj] != "Air source gas absorption heat pump" and const_eff[jj] != "Shallow geothermal gas absorption heat pump":
                    ...
                    elif technology == "Air source gas absorption heat pump" or technology == "Shallow geothermal gas absorption heat pump":
                        julia_category = str(tech.data(0, Qt.UserRole))
                        file = os.path.join(dr, "Result_" + julia_category + "_" + building_id + ".csv")
                        fec_source[1] = fec_source[1] + self.sum_file(file) / efficiency
                        for k in range(len(self.sourceName)):
                            if source == self.sourceName[k]:
                                fec_source[k] = fec_source[k] + self.sum_file(file) * (efficiency - 1) / efficiency

                for jj in range(len(variable_eff_el)):
                    if technology == variable_eff_el[jj] and technology != "Air source compression chiller" and technology != "Shallow geothermal compression chiller":
                        julia_category = str(tech.data(0, Qt.UserRole))
                        file = os.path.join(dr, "Result_" + julia_category + "_" + building_id + ".csv")
                        file_eta_HP_1 = os.path.join(dr, "../", "input", "eta_" + julia_category + ".csv")
                    ...
                    elif technology == "Air source compression chiller" or technology == "Shallow geothermal compression chiller":
                        julia_category = str(tech.data(0, Qt.UserRole))
                        file = os.path.join(dr, "Result_" + julia_category + "_" + building_id + ".csv")
                        file_eta_HP_cool = os.path.join(dr, "../", "input", "eta_" + julia_category + ".csv")

                        with open(file_eta_HP_cool) as fp:
                            COP_var = np.zeros(8760)
                            for ii, line in enumerate(fp):
                                COP_var[ii] = float(line.split(separator)[column])
        ...
        for i in range(widget.topLevelItemCount()):
            ...
            if item_network_id == network_id:
                for j in range(widget.topLevelItem(i).childCount()):
                    ...
                    efficiency = round(float(efficiency), 2)
                    technology = tech.text(0)
                    for jj in range(len(self.const_eff)):
                        if technology == self.const_eff[jj] and self.const_eff[jj] != "Air source gas absorption heat pump" and const_eff[jj] != "Shallow geothermal gas absorption heat pump" and "Waste heat absorption heat pump":
                            item_julia_category = str(tech.data(1, Qt.UserRole))
                            file = os.path.join(dr, "Result_" + item_julia_category + "_" + network_id + ".csv")
                            for k in range(len(self.sourceName)):
                                if source == self.sourceName[k]:
                                    fec_source[k] = fec_source[k] + self.sum_file(file) / efficiency / self.eco_param["eta_d"]
                        elif technology == "Air source gas absorption heat pump" or technology == "Shallow geothermal gas absorption heat pump" or "Waste heat absorption heat pump":
                            item_julia_category = str(tech.data(1, Qt.UserRole))
                            file = os.path.join(dr, "Result_" + item_julia_category + "_" + network_id + ".csv")
                            fec_source[1] = fec_source[1] + self.sum_file(file) / efficiency / self.eco_param["eta_d"]
                            for k in range(len(self.sourceName)):
                                if source == self.sourceName[k]:
                                    fec_source[k] = fec_source[k] + self.sum_file(file) * (efficiency - 1) / efficiency / \
                                                    self.eco_param["eta_d"]

                    for jj in range(len(self.variable_eff_el)):
                        if technology == self.variable_eff_el[jj]:
                            julia_category = str(tech.data(0, Qt.UserRole))
                            file = os.path.join(dr, "Result_" + item_julia_category + "_" + network_id + ".csv")
                            ...
                            fec_i = np.zeros_like(Q1)
                            for ii in range(len(fec_i)):
                                fec_i[ii] = Q1[ii] / COP_var[ii] / self.eco_param["eta_d"]
                            fec_2 = sum(fec_i)
                            fec_source[2] = fec_source[2] + fec_2
                            ...
                            for k in range(len(self.sourceName)):
                                if source == self.sourceName[k]:
                                    for ii in range(len(fec_i)):
                                        fec_i[ii] = Q1[ii] * (COP_var[ii] - 1) / COP_var[ii] / self.eco_param["eta_d"]
                                        fec_k = sum(fec_i)
                                        fec_source[k] = fec_source[k] + fec_k

                    for jj in range(len(self.variable_eff_ng)):
                        if technology == self.variable_eff_ng[jj]:
                            julia_category = str(tech.data(0, Qt.UserRole))
                            file = os.path.join(dr, "Result_" + item_julia_category + "_" + network_id + ".csv")
                            fec_source[1] = fec_source[1] + self.sum_file(file) / efficiency / self.eco_param["eta_d"]
                            for k in range(len(self.sourceName)):
        ...
        for i in range(item.childCount()):
            for j in range(item.child(i).childCount()):
                ...
                if technology.text(0) in YEOHbase.keys():
                    julia_category = str(technology.data(0, Qt.UserRole))
                    file = os.path.join(dr, "Result_" + julia_category + "_" + building_id + ".csv")
                    YEOHbase[technology.text(0)][0] = YEOHbase[technology.text(0)][0] + (self.sum_file(file)) / float(
                        technology.text(self.individual_tech_power_column))
                    try:
                        YEOHbase[technology.text(0)][1] = YEOHbase[technology.text(0)][1] + float(
                            technology.text(self.individual_tech_power_column))
                    except:
    ...
    def district_grant_contribution(self, use=None):
        ...
        for i in range(self.tech_tab.topLevelItemCount()):
            try:
                ...
                print("KPIsCalculator.py, district_grant_contribution(): item_network_id, item_julia_category", network_id,
                      item_julia_category)
            except:
                    ...
                    if tech.text(1) in self.variable_eff_el:
                        if os.path.isfile(file_eta) and os.path.isfile(file):
                            with open(file) as julia_ued, open(file_eta) as eta:
                                try:
                                    fec += float(eta.readline()) / float(julia_ued.readline())
                                except:
                                    pass
                    else:
                        try:
        ...
        if val < 0:
            ...
            for attempt in range(100):
                ...
                while flag:
                    ...
                    for j in range(years_nr):
                        tot_a = tot_a + 1 / ((1 + a) ** j)
                        tot_b = tot_b + 1 / ((1 + b) ** j)
                        tot_half = tot_half + 1 / ((1 + half) ** j)
                    if abs(tot_half - val) < 0.001:
                        return round(half, 2)
                    else:
                        if tot_half > val:
                            a = half
    ...
    def eco_3_punto_1(self, use=None):
        ...
        for i in range(years_nr):
            power_sum = power_sum + 1 / ((1 + r) ** i)
        if use is None:
            try:
                total = power_sum * (self.capext + self.opex)
    ...
    def get_emission_factor(self, source, column):
        for i in range(self.ef_sources_tab.rowCount()):
            if self.ef_sources_tab.verticalHeaderItem(i).text() == source:
                try:
                    return round(float(self.ef_sources_tab.item(i, column).text()), 2)
    ...
    def get_t_pollutant_sav(self, KPIs, pollutant_column, type="TOT"):
        ...
        for k, source in enumerate(self.sourceName):
            tCO2sav[k] = (adg_base[k] - fec) * self.get_emission_factor(source, pollutant_column)
    ...
    def get_el_sale_increment_district(self, use="TOT"):
        el_sale = 0
        if self.tech_tab is None:
            return el_sale
        for i in range(self.tech_tab.topLevelItemCount()):
        ...
        if use == "R":
            return el_sale * (self.areaR*self.area)
        if use == "T":
            return el_sale * (1-(self.areaR * self.area))
        return el_sale

    def get_el_sale_increment_building(self, use="TOT"):
        el_sale = 0.0
        for i in range(self.tech_tab.childCount()):
            ...
            for j in range(serv.childCount()):
                ...
                if not item_julia_category in ["CHP", "CHP_2"]:
                    break
                file = os.path.join(self.work_folder, "Results_" + item_julia_category + ".csv")
                el_sale += self.sum_file(file)*float(tech.text(11))*float(tech.text(22))
        if use == "R":
            return el_sale * (self.areaR*self.area)
        if use == "T":
            return el_sale * (1-(self.areaR * self.area))
