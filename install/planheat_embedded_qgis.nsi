...
;General
    ...
    ;Name and file
    Name "PLANHEAT"
    OutFile "planheat-1.0-qgis3-4-9-installer-win64.exe"
...
Function InstallQGIS
  SetOutPath $TEMP\QGIS_INSTALL
  MessageBox MB_YESNO "Install QGIS 3.4" /SD IDYES IDNO endInstallQGIS
    File "..\..\QGIS-OSGeo4W-3.4.9-1-Setup-x86_64.exe"
    ExecWait "$TEMP\QGIS_INSTALL\QGIS-OSGeo4W-3.4.9-1-Setup-x86_64.exe"
    Goto endInstallQGIS
  endInstallQGIS:
    Delete "$TEMP\QGIS_INSTALL\QGIS-OSGeo4W-3.4.9-1-Setup-x86_64.exe"
FunctionEnd
...
;Pages
	...
	!define MUI_PAGE_CUSTOMFUNCTION_PRE FindQGIS
